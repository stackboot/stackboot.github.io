...
mkdir -p "$GOPATH"/src/github.com/hajimehoshi/ebiten
mkdir -p "$GOPATH"/src/github.com/gopherjs/webgl

cp -r /Volumes/Things/Playground/src/github.com/hajimehoshi/ebiten/* "$GOPATH"/src/github.com/hajimehoshi/ebiten 
cp -r /Volumes/Things/Playground/src/github.com/gopherjs/webgl/* "$GOPATH"/src/github.com/gopherjs/webgl 
...
cp -a "$tmp"/gopath/pkg/*_js_min/* pkg/
